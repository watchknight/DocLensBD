  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#0F172A] via-[#1E293B] to-[#334155] relative overflow-hidden items-center justify-center">
        ...
        <div className="absolute bottom-20 left-20 w-48 h-48 bg-[#F59E0B]/10 rounded-full blur-3xl" />
        <div className="relative z-10 text-center px-12">
          ...
          <div className="mt-10 flex justify-center gap-8 text-center">
            <div className="glass rounded-2xl px-6 py-4">
              <div className="text-2xl font-display font-bold text-[#6366F1]">200+</div>
              <div className="text-white/40 text-xs mt-1">Frame Styles</div>
            </div>
            <div className="glass rounded-2xl px-6 py-4">
              <div className="text-2xl font-display font-bold text-[#F59E0B]">50K+</div>
      ...
      <div className="flex-1 flex flex-col justify-center py-12 px-6 sm:px-12 lg:px-20">
        <div className="max-w-md mx-auto w-full">
          <h2 className="text-3xl font-display font-extrabold text-[#0F172A] mb-2">Sign In</h2>
          <p className="text-[#475569] mb-8">
            Don't have an account?{' '}
            <Link to="/register" className="font-semibold text-[#6366F1] hover:text-[#4F46E5]">Create one</Link>
          </p>
          ...
          <form className="space-y-5" onSubmit={handleLogin}>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full flex justify-center items-center gap-2 py-3.5 rounded-xl font-bold text-white bg-[#0F172A] hover:bg-[#1E293B] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#0F172A] disabled:opacity-70 transition-colors btn-press text-sm"
            >
              {isLoading ? (
          ...
          <div className="mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-[#F8FAFC] text-[#94A3B8]">Or continue with</span>
              </div>
            </div>
